...
const FeaturedWork = () => {
  ...
  return (
    <FeaturedWorkContainer>
      <h2>Gallery</h2>
      <p>At Buraq Global Logistics, we deliver excellence in every mile. Explore our gallery to see our top-notch logistics services and meticulous maintenance in action.</p>
